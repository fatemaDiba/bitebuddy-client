      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          <img
            ...
            src="https://i.ibb.co.com/Bw4gSNX/pexels-catscoming-406152.jpg"
            alt="Food image"
          />
          <div className="p-5">
            <h2 className="text-lg font-semibold">Best Cooking Recipe</h2>
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          />
          <div className="p-5">
            <h2 className="text-lg font-semibold">Delicious Pasta</h2>
            <p className="text-gray-600 text-sm">Category: Italian</p>
            <p className="mt-2 text-gray-600 text-sm">
              Discover the art of cooking pasta with this simple and easy recipe
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          <img
            className="w-full object-cover h-56"
            src="https://i.ibb.co.com/bJ1X184/pexels-catscoming-920220.jpg"
            alt="Food image"
          />
          <div className="p-5">
