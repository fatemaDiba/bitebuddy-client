        ...
        <div className="text-amber-600 flex items-center pb-2 pr-2 border-b-2 border-amber-700 uppercase">
          ...
          >
            <g>
              ...
              <path d="M223.903,212.559c-3.513-2.194-8.14-1.124-10.334,2.39c-2.194,3.514-1.124,8.14,2.39,10.334l73.773,46.062 c1.213,0.754,2.586,1.131,3.96,1.131c1.417,0,2.833-0.401,4.071-1.201l16.556-10.7c3.479-2.249,4.476-6.891,2.228-10.37 c-2.248-3.479-6.891-4.475-10.37-2.228l-12.562,8.119l-60.119-37.38l48.2-30.355l59.244,37.147l-6.907,4.464 c-3.479,2.249-4.476,6.891-2.228,10.37c2.249,3.479,6.894,4.476,10.37,2.228l16.8-10.859c2.153-1.392,3.446-3.787,3.429-6.351 c-0.018-2.563-1.344-4.94-3.516-6.302l-73.218-45.909C150.749,127.792,147.647,127.795,145.209,129.33z" />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          <div className="relative">
            <a href="/salad-recipe">
              <img
                className="w-[94%] mx-auto h-56 object-cover"
                src="https://i.ibb.co.com/b6hF1fQ/pexels-catscoming-406152-1.jpg"
                alt=""
              />
              <div className="hover:bg-transparent transition duration-300 absolute bottom-0 top-0 right-0 left-0 bg-gray-900 opacity-25"></div>
            </a>
            <a href="//salad-recipe" rel="noopener noreferrer">
              <div className="text-sm absolute top-0 right-0 rounded-xl bg-light-accent px-4 py-2 text-white mt-3 mr-3 hover:bg-white hover:text-light-primary transition duration-500 ease-in-out">
                <FaLink />
              </div>
            </a>
          </div>
          <div className="p-5">
            <h2 className="text-lg font-semibold">Best Salad Recipe</h2>
            <p className="text-gray-600 text-sm">Category: Vegan</p>
            <p className="mt-2 text-gray-600 text-sm">
              From quick weekday meals to weekend, our recipes are designed for
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          <div className="relative">
            ...
            <a href="/pizza-recipe" rel="noopener noreferrer">
              <div className="text-sm absolute top-0 right-0 rounded-xl bg-light-accent px-4 py-2 text-white mt-3 mr-3 hover:bg-white hover:text-light-primary transition duration-500 ease-in-out">
                <FaLink />
              </div>
            </a>
          ...
          <div className="p-5">
            <h2 className="text-lg font-semibold">Delicious Pizza</h2>
            <p className="text-gray-600 text-sm">Category: Italian</p>
            <p className="mt-2 text-gray-600 text-sm">
              Discover the art of cooking Pizza with this simple and easy recipe
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          <div className="relative">
            ...
            <a href="/bread-recipe" rel="noopener noreferrer">
              <div className="text-sm absolute top-0 right-0 rounded-xl bg-light-accent px-4 py-2 text-white mt-3 mr-3 hover:bg-white hover:text-light-primary transition duration-500 ease-in-out">
                <FaLink />
              </div>
            </a>
          ...
          <div className="p-5">
            <h2 className="text-lg font-semibold">Best Bread Recipe</h2>
            <p className="text-gray-600 text-sm">Category: Bread</p>
            <p className="mt-2 text-gray-600 text-sm">
              Celebrate the seasons with recipes featuring the best produce each
              time of the year.
            </p>
            <div className="mt-4 text-xs text-gray-500 flex justify-between ">
